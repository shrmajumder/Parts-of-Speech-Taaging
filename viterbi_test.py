...
def run_viterbi_test():
    ...
    for t in range(num_tests):
        ...
        #rez = [[emission_scores[j][i] for j in range(len(emission_scores))] for i in range(len(emission_scores[0]))]
        #print(rez)
        #print(emission_scores,"aaaaa",trans_scores,"bbbbbbb",start_scores,"cccccccc",end_scores)
        #print ("Hi")
        # run viterbi
